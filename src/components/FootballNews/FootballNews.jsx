        ...
        <div class="col-md-6">
            <div class="card">
                <div class="d-flex justify-content-between p-2 px-3">
                    <div class="d-flex flex-row align-items-center"> <img src={e.imageuser} width="50" class="rounded-circle"/>
                        <div class="d-flex flex-column ml-2"> <span class="font-weight-bold">{e.username}</span> <small class="text-primary">{e.categorie}</small> </div>
                    </div>
                    <div class="d-flex flex-row mt-1 ellipsis"> <small class="mr-2">{e.postedat}</small> <i class="fa fa-ellipsis-h"></i> </div>
                </div> <img src={e.postimage} class="img-fluid"/>
                <div class="p-2">
